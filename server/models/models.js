...
Property.hasMany(PropertyImage, { onDelete: "CASCADE", onUpdate: "CASCADE" });
PropertyImage.belongsTo(Property);

//9. Пользователь может иметь много избранных объектов (ОДИН КО МНОГИМ)
User.hasMany(Wish, { onDelete: "CASCADE", onUpdate: "CASCADE" });
Wish.belongsTo(User);

//10. Объект жилья может быть в избранном у множества пользователей (ОДИН КО МНОГИМ)
Property.hasMany(Wish, { onDelete: "CASCADE", onUpdate: "CASCADE" });
...
Booking.hasOne(PropertyReview, { onDelete: "CASCADE", onUpdate: "CASCADE" });
...
Booking.hasOne(HostReview, { onDelete: "CASCADE", onUpdate: "CASCADE" });
