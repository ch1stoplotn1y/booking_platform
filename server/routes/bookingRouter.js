...
bookingRouter.get('/', checkRoleFunction('admin'), bookingController.getAllBookings)
bookingRouter.post('/',authFunction, bookingController.createBooking)
bookingRouter.post('/cancel',checkRoleFunction('admin'), bookingController.cancelBooking)
